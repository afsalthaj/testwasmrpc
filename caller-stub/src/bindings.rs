                        ...
                        pub mod caller_stub {
                          ...
                          pub mod stub_caller {
                            ...
                            const _: () = {
                              ...
                              #[doc(hidden)]
                              #[export_name = "test:caller-stub/stub-caller#[method]api.run-self"]
                              #[allow(non_snake_case)]
                              unsafe extern "C" fn __export_method_api_run_self(arg0: i32,arg1: i32,arg2: i32,) -> i32 {
                                #[allow(unused_imports)]
                                use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                                ...
                                let result1 = <_ApiImpl as GuestApi>::run_self(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), wit_bindgen::rt::string_lift(bytes0));
                              ...
                              const _: () = {
                                #[doc(hidden)]
                                #[export_name = "cabi_post_test:caller-stub/stub-caller#[method]api.run-self"]
                                #[allow(non_snake_case)]
                                unsafe extern "C" fn __post_return_method_api_run_self(arg0: i32,) {
                            ...
                            const _: () = {
                              ...
                              #[doc(hidden)]
                              #[export_name = "test:caller-stub/stub-caller#[method]api.run-remote"]
                              #[allow(non_snake_case)]
                              unsafe extern "C" fn __export_method_api_run_remote(arg0: i32,arg1: i32,arg2: i32,) -> i32 {
                                #[allow(unused_imports)]
                                use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                                ...
                                let len0 = arg2 as usize;
                                let bytes0 = Vec::from_raw_parts(arg1 as *mut _, len0, len0);
                                let result1 = <_ApiImpl as GuestApi>::run_remote(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), NewType{
                                  value: wit_bindgen::rt::string_lift(bytes0),
                                });
                                let ptr2 = _RET_AREA.0.as_mut_ptr() as i32;
                              ...
                              const _: () = {
                                #[doc(hidden)]
                                #[export_name = "cabi_post_test:caller-stub/stub-caller#[method]api.run-remote"]
                                #[allow(non_snake_case)]
                                unsafe extern "C" fn __post_return_method_api_run_remote(arg0: i32,) {
                                  let l0 = *((arg0 + 0) as *const i32);
                                  let l1 = *((arg0 + 4) as *const i32);
                                  wit_bindgen::rt::dealloc(l0, (l1) as usize, 1);
                                }
                            ...
                            pub trait GuestApi {
                              ...
                              fn run_self(&self,name: wit_bindgen::rt::string::String,) -> NewType;
                              fn run_remote(&self,remote: NewType,) -> wit_bindgen::rt::string::String;
                            }
