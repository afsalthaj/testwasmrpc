              ...
              let base = result12 as i32 + (i as i32) * 8;
              {
                ...
                impl WasmRpc {
                  ...
                  pub fn invoke(&self,function_name: &str,function_params: &[WitValue],) -> Result<(),RpcError>{
                    ...
                    pub mod test {
                      pub mod callee2 {
                        ...
                        pub mod api {
                          ...
                          static __FORCE_SECTION_REF: fn() = super::super::super::__link_section;
                          #[derive(Clone)]
                          pub struct Callee2Type {
                            pub value: wit_bindgen::rt::string::String,
                          }
                          impl ::core::fmt::Debug for Callee2Type {
                            fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                              f.debug_struct("Callee2Type").field("value", &self.value).finish()
                            }
                          }
                          #[allow(unused_unsafe, clippy::all)]
                          pub fn run(name: &str,) -> Callee2Type{
                            ...
                            unsafe {
                              ...
                              #[cfg(target_arch = "wasm32")]
                              #[link(wasm_import_module = "test:callee2/api")]
                              extern "C" {
                                #[link_name = "run"]
                    ...
                    pub mod exports {
                      pub mod test {
                        pub mod callee2_stub {
                          
                          #[allow(clippy::all)]
                          pub mod stub_callee2 {
                            #[used]
                            #[doc(hidden)]
                            #[cfg(target_arch = "wasm32")]
                            static __FORCE_SECTION_REF: fn() = super::super::super::super::__link_section;
                            pub type Uri = super::super::super::super::golem::rpc::types::Uri;
                            pub type Callee2Type = super::super::super::super::test::callee2::api::Callee2Type;
                            
                            pub use super::super::super::super::super::Api as Api;
                            const _: () = {
                              #[doc(hidden)]
                              #[export_name = "test:callee2-stub/stub-callee2#[dtor]api"]
                            ...
                            unsafe impl wit_bindgen::rt::RustResource for Api{
                              unsafe fn new(_rep: usize) -> u32 {
                                ...
                                #[cfg(target_arch = "wasm32")]
                                {
                                  #[link(wasm_import_module = "[export]test:callee2-stub/stub-callee2")]
                                  extern "C" {
                            ...
                            const _: () = {
                              ...
                              #[doc(hidden)]
                              #[export_name = "test:callee2-stub/stub-callee2#[constructor]api"]
                              #[allow(non_snake_case)]
                            ...
                            const _: () = {
                              ...
                              #[doc(hidden)]
                              #[export_name = "test:callee2-stub/stub-callee2#[method]api.run"]
                              #[allow(non_snake_case)]
                              unsafe extern "C" fn __export_method_api_run(arg0: i32,arg1: i32,arg2: i32,) -> i32 {
                                ...
                                let super::super::super::super::test::callee2::api::Callee2Type{ value:value3, } = result1;
                              ...
                              const _: () = {
                                #[doc(hidden)]
                                #[export_name = "cabi_post_test:callee2-stub/stub-callee2#[method]api.run"]
                                #[allow(non_snake_case)]
                            ...
                            pub trait GuestApi {
                              ...
                              fn run(&self,name: wit_bindgen::rt::string::String,) -> Callee2Type;
                            }
