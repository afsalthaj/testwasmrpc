                    ...
                    pub mod test {
                      pub mod callee_stub {
                        ...
                        pub mod stub_callee {
                          ...
                          impl Api {
                            #[allow(unused_unsafe, clippy::all)]
                            pub fn run_callee(&self,input: &str,) -> wit_bindgen::rt::string::String{
                              ...
                              unsafe {
                                ...
                                #[link(wasm_import_module = "test:callee-stub/stub-callee")]
                                extern "C" {
                                  #[link_name = "[method]api.run-callee"]
                          ...
                          pub mod api {
                            ...
                            const _: () = {
                              ...
                              unsafe extern "C" fn __export_run_remote(arg0: i32,arg1: i32,) -> i32 {
                                ...
                                let len0 = arg1 as usize;
                                let bytes0 = Vec::from_raw_parts(arg0 as *mut _, len0, len0);
                                let result1 = <_GuestImpl as Guest>::run_remote(NewType{
                            ...
                            pub trait Guest {
                              fn run_self(name: wit_bindgen::rt::string::String,) -> NewType;
                              fn run_remote(remote: NewType,) -> wit_bindgen::rt::string::String;
                            }
