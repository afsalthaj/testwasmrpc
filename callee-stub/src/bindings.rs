                        ...
                        pub mod callee_stub {
                          ...
                          pub mod stub_callee {
                            ...
                            const _: () = {
                              ...
                              #[doc(hidden)]
                              #[export_name = "test:callee-stub/stub-callee#[method]api.run-callee"]
                              #[allow(non_snake_case)]
                              unsafe extern "C" fn __export_method_api_run_callee(arg0: i32,arg1: i32,arg2: i32,) -> i32 {
                                #[allow(unused_imports)]
                                use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                                ...
                                let result1 = <_ApiImpl as GuestApi>::run_callee(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), wit_bindgen::rt::string_lift(bytes0));
                              ...
                              const _: () = {
                                #[doc(hidden)]
                                #[export_name = "cabi_post_test:callee-stub/stub-callee#[method]api.run-callee"]
                                #[allow(non_snake_case)]
                                unsafe extern "C" fn __post_return_method_api_run_callee(arg0: i32,) {
                            ...
                            pub trait GuestApi {
                              ...
                              fn run_callee(&self,input: wit_bindgen::rt::string::String,) -> wit_bindgen::rt::string::String;
                            }
