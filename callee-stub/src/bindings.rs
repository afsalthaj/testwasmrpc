                      ...
                      pub mod test {
                        pub mod callee_stub {
                          ...
                          pub mod stub_callee {
                            ...
                            pub type CalleeType = super::super::super::super::test::callee::api::CalleeType;
                            
                            pub use super::super::super::super::super::Api as Api;
                            const _: () = {
                              #[doc(hidden)]
                              #[export_name = "test:callee-stub/stub-callee#[dtor]api"]
                            ...
                            unsafe impl wit_bindgen::rt::RustResource for Api{
                              unsafe fn new(_rep: usize) -> u32 {
                                ...
                                #[cfg(target_arch = "wasm32")]
                                {
                                  #[link(wasm_import_module = "[export]test:callee-stub/stub-callee")]
                                  extern "C" {
                            ...
                            const _: () = {
                              ...
                              #[doc(hidden)]
                              #[export_name = "test:callee-stub/stub-callee#[constructor]api"]
                              #[allow(non_snake_case)]
                            ...
                            const _: () = {
                              ...
                              #[doc(hidden)]
                              #[export_name = "test:callee-stub/stub-callee#[method]api.run"]
                              #[allow(non_snake_case)]
                              unsafe extern "C" fn __export_method_api_run(arg0: i32,arg1: i32,arg2: i32,) -> i32 {
                                ...
                                let super::super::super::super::test::callee::api::CalleeType{ value:value3, } = result1;
                              ...
                              const _: () = {
                                #[doc(hidden)]
                                #[export_name = "cabi_post_test:callee-stub/stub-callee#[method]api.run"]
                                #[allow(non_snake_case)]
                            ...
                            pub trait GuestApi {
                              ...
                              fn run(&self,name: wit_bindgen::rt::string::String,) -> CalleeType;
                            }
